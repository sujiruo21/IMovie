...
import com.zl.imoivesdk.constant.SDKConstant;
import com.zl.imoivesdk.constant.SDKConstant.AutoPlaySetting;
import com.zl.imoivesdk.core.AdParameters;
import com.zl.imovie.R;
import com.zl.imovie.activity.base.BaseActivity;
import com.zl.imovie.db.SharedPreferencesManager;
...
public class SettingActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        int currentSetting = SharedPreferencesManager.getInstance().getInt(SharedPreferencesManager.VIDEO_PLAY_SETTING, 1);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.alway_layout:
                SharedPreferencesManager.getInstance().putInt(SharedPreferencesManager.VIDEO_PLAY_SETTING, 0);
            ...
            case R.id.close_layout:
                SharedPreferencesManager.getInstance().putInt(SharedPreferencesManager.VIDEO_PLAY_SETTING, 2);
            ...
            case R.id.wifi_layout:
                SharedPreferencesManager.getInstance().putInt(SharedPreferencesManager.VIDEO_PLAY_SETTING, 1);
